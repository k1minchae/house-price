...
<p style="font-size: 2.5rem; font-weight: bold; text-align: center;">  특정 동네를 선호하는 손님을 위한 익스테리어 안내 매뉴얼</p>
...
IFrame(src='../assets/map_single_top5.html', width='100%', height='600px')
```
